...
/// [entry](EntryMut), you need to borrow the entire world mutably. This prevents you from
...
/// component types requested by a [view](View). This will create two subworlds, the left one allowing
