...
pub mod ser {
    ...
    use crate::{
        ...
        storage::{Archetype, ArchetypeIndex, ComponentTypeId, UnknownComponentStorage},
        world::World,
    };
...
pub mod de {
    ...
    use crate::{
        ...
        storage::{
            ArchetypeIndex, ComponentIndex, ComponentTypeId, EntityLayout, UnknownComponentStorage,
        },
        world::World,
    };
    use serde::{
